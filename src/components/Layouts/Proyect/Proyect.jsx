...
export const Proyect = ({
  ...
  return (
    <div className="max-w-sm rounded-lg overflow-hidden shadow-lg transition-transform transform hover:translate-y-2 w-full sm:w-72 md:w-80 lg:w-96">
      <img className="w-full h-48 object-cover hover:scale-105 transition duration-500" src={img} alt="Project Image"/>
